...
class SPS30:
    ...
    _CMD_START_MEASUREMENT = const(0x0010)
    _CMD_STOP_MEASUREMENT = const(0x0104)
    _CMD_READ_DATA_READY_FLAG = const(0x0202)
    _CMD_READ_MEASURED_VALUES = const(0x0300)
    _CMD_SLEEP = const(0x1001)  # V2.0
    _CMD_WAKEUP = const(0x1103)  # V2.0
    _CMD_START_FAN_CLEANING = const(0x5607)
    _CMD_RW_AUTO_CLEANING_INTERVAL = const(0x8004)
    _CMD_READ_PRODUCT_TYPE = const(0xD002)
    _CMD_READ_SERIAL_NUMBER = const(0xD033)
    _CMD_READ_VERSION = const(0xD100)
    _CMD_READ_DEVICE_STATUS_REG = const(0xD206)  # V2.2
    _CMD_CLEAR_DEVICE_STATUS_REG = const(0xD210)  # V2.0
